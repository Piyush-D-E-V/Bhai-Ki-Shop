...
export function Header() {
  ...
  return (
    <header className="fixed w-full top-0 z-50 border-b bg-white/10 backdrop-blur-md dark:border-zinc-800 dark:bg-zinc-950/80">
      <div className="mx-auto flex h-16 max-w-7xl items-center justify-between px-4 sm:px-6 lg:px-8">
        {/* Logo */}
        <Link href="/" className="flex items-center gap-2">
          <span className="text-xl font-bold text-white dark:text-zinc-100">
            TechticalRig
          </span>
        </Link>
